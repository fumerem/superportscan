...
fn main() {
    ...
    if ports == "default_port" {
        let port_to_scan: Vec<u16> = vec![
            80, 5601, 23, 443, 21, 22, 25, 3389, 110, 445, 139, 143, 53, 135, 3306, 8080, 1723, 111,
            ...
            3369, 7402, 5054, 3918, 3077, 7443, 3493, 3828, 1186, 2179, 1183, 19315, 1923, 5963, 3995,
